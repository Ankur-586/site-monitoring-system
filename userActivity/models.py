...
class LoggedInUserActivity(models.Model):
...
# how to determine which ipaddress currently visited mysite in django and save each record to later track ip address
